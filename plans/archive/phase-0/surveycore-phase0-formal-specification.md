...
- Called automatically in `as_survey()`, `as_survey_replicate()`, `as_survey_twophase()`
...
- [ ] Constructor functions work for all design types (as_survey, as_survey_replicate, as_survey_twophase)
...
#' rep_design <- as_survey_replicate(
#'   my_data,
#'   weights = wt,
