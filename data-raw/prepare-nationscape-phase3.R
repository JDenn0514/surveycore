## Democracy Fund + UCLA Nationscape — Phase 3 (Waves 51–77)
...
##
## Phase 3 coverage: July 2, 2020 – January 12, 2021 (27 weekly waves)
## Waves: ns20200702 through ns20210112
## Sample: ~6,250 completed interviews per wave (~168,750 total)
...
##   - 2020 general election vote intent added (vote_2020, vote_2020_lean)
##   - Issue-specific Trump approval items added (extra_trump_*)
##   - COVID-19 items continue and expand
##   - Post-November 2020 waves: vote_2020 reflects actual vote choice
##
## Run from the package root: source("data-raw/prepare-nationscape-phase3.R")
...
PHASE3_DIR <- file.path(here::here(), "data-raw", "nationscape", "phase_3_v20210301")

if (!dir.exists(PHASE3_DIR)) {
  stop(
    "Phase 3 data not found at: ", PHASE3_DIR, "\n",
...
## ---- Phase 3 battery definitions ----

BATTERIES_PHASE3 <- list(
  ...
  ## Group favorability (Phase 3 adds Black Lives Matter movement)
  group_fav = list(
    ...
    vars = c(
      ...
      ## Phase 3 addition
      group_favorability_blm           = "The Black Lives Matter movement"
    )
  ),
  ...
  ## Trump head-to-head matchups (Phase 3: Biden vs. Trump is primary contest)
  trump_matchup = list(
  ...
  ## Issue-specific Trump approval (Phase 3 addition)
  ##
  ## "Do you approve or disapprove of the way Donald Trump is handling...?"
  extra_trump_approval = list(
    preface = "Do you approve or disapprove of the way Donald Trump is handling each of the following?",
    vars = c(
      extra_trump_economy    = "The economy",
      extra_trump_health     = "Healthcare policy",
      extra_trump_foreign    = "Foreign affairs",
      extra_trump_immigration = "Immigration",
      extra_trump_trade      = "Foreign trade",
      extra_trump_race       = "Race relations",
      extra_trump_taxes      = "Taxes",
      extra_trump_climate    = "Climate change",
      extra_trump_budget     = "The federal budget deficit",
      extra_trump_corona     = "The coronavirus/COVID-19 pandemic"
    )
  ),

  ## COVID-19 behaviors battery
  ...
  ## Vote in 2020 (Phase 3 addition)
  ##
  ## Pre-election waves: intent; post-November 2020 waves: reported vote.
  ## vote_2020_lean asked of undecided respondents.
  vote_2020 = list(
    preface = "If the election for president were going to be held now and the Democratic Party nominates Joe Biden as their candidate, who would you vote for?",
    vars = c(
      vote_2020           = "Selected choice",
      vote_2020_other_text = "Write-in (other)",
      vote_2020_lean       = "Lean (undecided follow-up)"
    )
  ),
...
## ---- Main: load and process all Phase 3 waves ----

ns_phase3 <- load_phase_waves(PHASE3_DIR, BATTERIES_PHASE3, "Phase 3")
