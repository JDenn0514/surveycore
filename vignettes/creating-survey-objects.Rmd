...
| | `as_survey()` / `as_survey_replicate()` | `as_survey_srs()` | `as_survey_calibrated()` |
|---|---|---|---|
...
|---|---|---|
| Probability sample with design weights | `as_survey()`, `as_survey_replicate()`, `as_survey_srs()` | Exact variance |
