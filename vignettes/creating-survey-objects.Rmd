...
`as_survey_srs()`, and `as_survey_nonprob()` — differ in one fundamental
way: *where the weights come from*.

| | `as_survey()` / `as_survey_replicate()` | `as_survey_srs()` | `as_survey_nonprob()` |
|---|---|---|---|
...
collection, use `as_survey_nonprob()`.
