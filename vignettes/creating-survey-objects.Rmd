...
- **Non-probability panel users** — if you use non-probability samples, like
  Cint or other non-probability samples, skip ahead to [Section 6](#sec-nps).

This vignette covers object *creation* only. Two things not covered are:
- How to create weights and how the different weighting methods work. 
