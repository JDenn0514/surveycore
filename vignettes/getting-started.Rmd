...
```{r corr-basic, eval=has_surveytidy}
...
```{r corr-multi, eval=has_surveytidy}
ns_wave1_svy |>
...
```{r corr-wide, eval=has_surveytidy}
ns_wave1_svy |>
  drop_na(c(cand_favorability_trump:cand_favorability_pence)) |>
  # filter out any respondents who said "Not sure"
  filter_out(
...
```{r ratios-basic, eval=has_surveytidy}
ns_wave1_svy |>
  # drop NAs
  drop_na(cand_favorability_trump, cand_favorability_biden) |>
...
```{r surveytidy-group_by, eval=has_surveytidy}
ns_wave1_svy |>
  group_by(age_f4) |>
