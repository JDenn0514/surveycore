...
when objects are printed; documented here for reference.

- [`print(`*`<survey_result>`*`)`](https://jdenn0514.github.io/surveycore/reference/print.survey_result.md)
  : Print a Survey Result Object
- [`print(`*`<survey_diffs>`*`)`](https://jdenn0514.github.io/surveycore/reference/print.survey_diffs.md)
  : Print a Survey Diffs Result
- [`print(`*`<survey_t_test>`*`)`](https://jdenn0514.github.io/surveycore/reference/print.survey_t_test.md)
  : Print method for survey_t_test objects.
- [`print(`*`<survey_pairwise>`*`)`](https://jdenn0514.github.io/surveycore/reference/print.survey_pairwise.md)
  : Print method for survey_pairwise objects.
- [`print(`*`<survey_anova>`*`)`](https://jdenn0514.github.io/surveycore/reference/print.survey_anova.md)
  : Print Method for survey_anova Objects
- [`anova(`*`<survey_glm_fit>`*`)`](https://jdenn0514.github.io/surveycore/reference/anova.survey_glm_fit.md)
...
- [`ca_api_2000`](https://jdenn0514.github.io/surveycore/reference/ca_api_2000.md)
