...
Check for `plans/spec-methods-review-{id}.md`.
...
> "No methodology review file found at `plans/spec-methods-review-{id}.md`.
...
Work through BLOCKING issues first, then REQUIRED, then ADVISORY.
...
- Stage 2 does not reopen unless new statistical components are added to the
  spec (e.g., a new variance method, a new estimator, a new family of models)
