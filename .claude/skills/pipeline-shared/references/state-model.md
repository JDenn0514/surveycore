...
3. **BLOCK reverts one state.** A tester BLOCK reverts `PIPELINES_COMPLETE → PLAN_READY` for that PR. Builder is re-dispatched. Maximum 3 BLOCK cycles per PR; at 3, escalate to user (HOLD).
