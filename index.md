...
- **Metadata system**: variable labels, value labels, question prefaces,
  ...
  and more; extract with the matching `extract_*()` family. Haven-style
  label attributes are imported automatically.
- **Analysis functions**:
...
- **Calibration**:
  ...
  constructs calibration data for GREG-corrected variance on Taylor and
  replicate designs
- **Design utilities**:
...
[`survey_glm()`](https://jdenn0514.github.io/surveycore/reference/survey_glm.md)
fits survey-weighted generalized linear models.
...
- **surveywts**: weight adjustment utilities for survey data.
  ...
  [`as_caldata()`](https://jdenn0514.github.io/surveycore/reference/as_caldata.md);
  additional weight adjustment methods are in development.
